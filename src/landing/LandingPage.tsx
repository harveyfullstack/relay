  ...
  const plans = [
    {
      ...
      features: ['2 workspaces', '3 agents per workspace', '10 compute hours/month', 'Community support'],
      cta: 'Get Started',
      highlighted: false,
    },
    {
      ...
      features: ['10 workspaces', '10 agents per workspace', '100 compute hours/month', 'Custom domains', 'Email support'],
    ...
    },
    {
      ...
      features: ['50 workspaces', '25 agents per workspace', '500 compute hours/month', 'Priority support', 'Audit logs'],
      cta: 'Start Free Trial',
      highlighted: false,
    },
    {
      ...
      features: ['Unlimited everything', 'SSO/SAML', 'SLA guarantee', 'Dedicated account manager', 'Custom integrations'],
      cta: 'Contact Sales',
      highlighted: false,
    },
  ];
