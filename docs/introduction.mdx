...
Monitor agent communication through the CLI tools. Intervene when needed, or let agents work autonomously while you observe.

## Architecture Overview

Agent Relay consists of two main components:
