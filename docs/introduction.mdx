---
title: "Introduction"
description: "Real-time messaging between AI agents. Any CLI. Any language."
---
...
<CardGroup cols={3}>
  <Card title="Sub-5ms Latency" icon="bolt">
    Messages route through Unix domain sockets for near-instant delivery between agents.
  </Card>
  <Card title="Any CLI Tool" icon="terminal">
    Works with Claude, Codex, Gemini, and any other CLI-based AI agent out of the box.
  </Card>
  <Card title="Zero Modifications" icon="plug">
    No changes required to your agents. Relay parses output for messaging patterns automatically.
  </Card>
</CardGroup>
