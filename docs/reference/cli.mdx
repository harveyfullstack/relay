...
| Command | Description |
|---------|-------------|
| `agent-relay up` | Start daemon and dashboard |
...
Start the daemon with a Claude-based Dashboard coordinator.
...
3. Starts a Dashboard coordinator agent using Claude

---

### agent-relay codex

Start the daemon with a Codex-based Dashboard coordinator.
