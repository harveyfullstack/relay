...
- ✅ Cloud deployment with Docker + workspace namespacing (504-505, 488-490)
- ✅ File-based continuity core features (497-498)
- ✅ Stuck detection (501)
- ✅ Rust CI integration (506)
- ✅ All Cursor scaling P0 features (510-512)

**Remaining work: 7 tasks across validation testing, conditional features, and documentation cleanup.**

---

## ✅ COMPLETED & MERGED (16 Beads)
...
|------|------|--------|----|----|
| **agent-relay-483** | Protocol sync fields | ✅ MERGED | #218 | Jan 19 |
| **agent-relay-484** | Daemon pending ACK tracking | ✅ MERGED | #218 | Jan 19 |
| **agent-relay-485** | Client sendAndWait() API | ✅ MERGED | #218 | Jan 19 |
| **agent-relay-486** | Auto-ACK on correlationId | ✅ MERGED | #218 | Jan 19 |
| **agent-relay-492** | Parse [await] syntax | ✅ MERGED | #218 | Jan 19 |
| **agent-relay-493** | Update docs for [await] | ✅ MERGED | #218 | Jan 19 |
...
| Bead | Task | Status | PR | Date |
|------|------|--------|----|----|
| **agent-relay-504** | Deploy Rust relay-pty to cloud | ✅ MERGED | #205 | Jan 17 |
| **agent-relay-505** | WORKSPACE_ID env propagation | ✅ MERGED | #210 | Jan 18 |
| **agent-relay-488** | Socket path namespacing | ✅ MERGED | #210 | Jan 18 |
| **agent-relay-489** | Outbox path namespacing | ✅ MERGED | #210 | Jan 18 |
| **agent-relay-490** | Rust workspace paths | ✅ MERGED | #217 | Jan 19 |
...
| Bead | Task | Status | PR | Date |
|------|------|--------|----|----|
| **agent-relay-497** | Rust continuity parsing | ✅ MERGED | #217 | Jan 19 |
| **agent-relay-498** | Orchestrator continuity | ✅ MERGED | #217 | Jan 19 |
| **agent-relay-499** | Auto-fallback continuity | ❓ UNKNOWN | - | - |
| **agent-relay-500** | Remove old [[SUMMARY]] parsing | ❓ UNKNOWN | - | - |
...
| Bead | Task | Status | PR | Date |
|------|------|--------|----|----|
| **agent-relay-501** | Stuck detection heuristics | ✅ MERGED | main | Jan 17 |
...
| Bead | Task | Status | PR | Date |
|------|------|--------|----|----|
| **agent-relay-506** | Add Rust tests to CI | ✅ MERGED | #211 | Jan 17 |
| **agent-relay-507** | Improve Rust coverage | ❓ UNKNOWN | - | - |
| **agent-relay-508** | On-demand binary download | ❌ NOT STARTED | - | v2 |
...
| Bead | Task | Status | PR | Date |
|------|------|--------|----|----|
| **agent-relay-510** | Model selection hookup | ✅ MERGED | #240 | Jan 16 |
| **agent-relay-511** | Documentation sprint | ✅ MERGED | #238 | Jan 17 |
| **agent-relay-512** | Role-specific prompts | ✅ MERGED | main | Jan 17 |
...
- Cursor saw "20 agents → 2-3 effective throughput" - do we?
- If yes → Need agent-relay-515 (optimistic concurrency)
- If no → Current file-based state is fine
...
- If yes → Need agent-relay-516 (auto fresh starts)
- If no → Current model is stable
...
- [ ] Scale test shows 20→20 effective throughput
...
3. Profile updates:
   - Add `role:` to all 18+ agent profiles
...
- `src/daemon/server.ts` - Role validation
...
- [ ] Daemon enforces spawn permissions
- [ ] All profiles have role
...
**Status:** ❓ UNCLEAR - May be done or deferred
...
┌─────────────────────────────────────────┐
│  agent-relay-513 (scale test - 20 agents) │
│  agent-relay-514 (drift test - long-run)  │
└─────────────┬───────────────┬────────────┘
              │               │
         GO? ─┘               └─ GO?
              │                   │
...
**v1.4.0 (Shipped):**
- Sync messaging protocol (483-493) ✅
- Cloud deployment (504-505, 488-490) ✅
- File-based continuity (497-498) ✅
- Stuck detection (501) ✅
- Rust CI tests (506) ✅
- Cursor P0 features (510-512) ✅
