...
| `leadName` | Name of the lead agent | `Dashboard` |
...
Each project's dashboard shows bridge status when connected:

- **Bridge Status** - Connected/Disconnected indicator
- **Bridged Projects** - List of connected projects
- **Project Leads** - Status of lead agents in each project
- **Message Flow** - Cross-project messages
